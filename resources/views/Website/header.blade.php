...
<body>
    <section class="header">
        <nav id="navbar_top" class="navbar navbar-expand-lg navbar-dark bg-light main-navigation" id="navbar">
          <div class="container">
            <a class="navbar-brand" href="#" style="color:#2d2f30 !important">LOGO</a>
            <button class="navbar-toggler bg-dark" type="button">
            <span class="navbar-toggler-icon bg-dark"  ></span>
            </button>
            <div class="overlay d-flex d-lg-none"></div>
            <div class="order-lg-2 bg-light d-lg-flex w-100 sidebar pb-3 pb-lg-0">
              <ul class="navbar-nav ms-lg-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a class="nav-link px-3 px-lg-2 active fw-bold" aria-current="page" href="#" style="color:#2d2f30 !important">
                    &nbsp;Gyaan
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link px-3 px-lg-2 fw-bold" href="#" style="color:#2d2f30 !important">
                    &nbsp;Cars
                  </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link px-3 px-lg-2 fw-bold" href="{{URL::to('/Website/Comparisions') }}" style="color:#2d2f30 !important">
                    &nbsp;Comparision
                  </a>
                </li>
                <li class="nav-item">
