...
Route::get('Website/comparision1/', [FourwheelerspecsfeatureController::class, 'comparision1'])->name('Newmodel');
Route::get('Website/comparision2/', [FourwheelerspecsfeatureController::class, 'comparision2'])->name('Newmodel');
...
Route::get('Website/compare2', [TwowheelerspecsfeatureController::class, 'comparetwowheeler'])->name('Newmodel');
//Images delete function 
...
Route::get('/Website/Home', [DekhoEVHomeController::class, 'Index']);
Route::get('', [DekhoEVHomeController::class, 'Index']);
Route::get('/Website/Comparisions-new', [DekhoEVHomeController::class, 'Comparision_new']);
Route::get('/Website/who-we-are', [DekhoEVHomeController::class, 'who_we_are']);
Route::get('/Website/who-are-you', [DekhoEVHomeController::class, 'who_are_you']);
Route::get('/Website/terms-and-condition', [DekhoEVHomeController::class, 'terms_and_condition']);
...
Route::post('/Website/Comparisions-Table-Three-Wheeler-Pass', [DekhoEVHomeController::class, 'Comparision_Table_Three_Wheeler_Pass']);
Route::post('/Website/Comparisions-Table-Three-Wheeler-Cargo', [DekhoEVHomeController::class, 'Comparision_Table_Three_Wheeler_Cargo']);
Route::post('/Website/Comparisions-Table-Four-Wheeler', [DekhoEVHomeController::class, 'Comparision_Table_Four_Wheeler']);
Route::post('/Website/Comparisions-Table-Two-Wheeler', [DekhoEVHomeController::class, 'Comparision_Table_Two_Wheeler']);

// Comparision starts Nov month 
Route::get('/Website/Comparisions-Two-Wheeler-Specs', [ComparisonController::class, 'Comparision_Two_Wheeler_Specs']);
Route::get('/Website/Comparisions-Four-Wheeler-Specs', [ComparisonController::class, 'Comparision_Four_Wheeler_Specs']);
Route::get('/Website/Comparisions-Three-Wheeler-Cargo', [ComparisonController::class, 'Comparision_Three_Wheeler_Cargo']);
Route::get('/Website/Comparisions-Three-Wheeler-Pass', [ComparisonController::class, 'Comparision_Three_Wheeler_Pass']);


Route::get('/Website/Four-Wheeler-Vehicle-Catelogue', [DekhoEVHomeController::class, 'Four_Wheeler_Vehicle_Catelogue']);
Route::get('/Website/Two-Wheeler-Vehicle-Catelogue', [DekhoEVHomeController::class, 'Two_Vehicle_Vehicle_Catelogue']);
Route::get('/Website/Three-Wheeler-Cargo-Vehicle-Catelogue', [DekhoEVHomeController::class, 'Three_Wheeler_cargo_Vehicle_Catelogue']);
Route::get('/Website/Three-Wheeler-Pass-Vehicle-Catelogue', [DekhoEVHomeController::class, 'Three_Wheeler_pass_Vehicle_Catelogue']);
Route::get('/Website/Four-Wheeler-Product-Details', [DekhoEVHomeController::class, 'Four_Wheeler_Product_Details']);

Route::get('/Website/Four-Wheeler-Product-Details/Model', [DekhoEVHomeController::class, 'Four_Wheeler_Product_Details']);

Route::get('/Website/Two-Wheeler-Product-Details', [DekhoEVHomeController::class, 'Two_Wheeler_Product_Details']);
Route::get('/Website/Three-Wheeler-Cargo-Product-Details', [DekhoEVHomeController::class, 'Three_Wheeler_Cargo_Product_Details']);
Route::get('/Website/Three-Wheeler-Pass-Product-Details', [DekhoEVHomeController::class, 'Three_Wheeler_Pass_Product_Details']);

//home page controller
Route::get('/Website/Twowheeler-details', [DekhoEVHomeController::class, 'twowheelerproducts']);
Route::get('/Website/Fourwheeler-details', [DekhoEVHomeController::class, 'fourwheelerproducts']);
Route::get('/Website/Threewheelercargo-details', [DekhoEVHomeController::class, 'threewheelercargoproducts']);
Route::get('/Website/Threewheelerpass-details', [DekhoEVHomeController::class, 'threewheelerpassproducts']);

//Feedback Route
Route::get('/Website/Feedback', [FeedbackController::class, 'create']);
Route::post('/Website/Feedback/save/', [FeedbackController::class, 'store']);
Route::get('/Website/Feedback/View/', [FeedbackController::class, 'show']);
Route::get('/Website/Feedback/delete/{id}', [FeedbackController::class, 'destroy']);
Route::get('/Website/Feedback/view/{id}', [FeedbackController::class, 'Viewcomments']);
...
//Review
Route::get('/Wesite/Review/index/', [ReviewController::class, 'index']);
Route::get('/Wesite/ReviewForm1', [ReviewController::class, 'review_form1']);
Route::post('/Website/Review/Owner_Store', [ReviewController::class, 'Owner_review_store']);
Route::post('/Website/Review/Blogger_store', [ReviewController::class, 'Blogger_review_store']);
Route::post('/Website/Review/Oem_store', [ReviewController::class, 'Oem_review_store']);

Route::post('/Website/Review/login_store', [ReviewController::class, 'login_review_store']);
Route::post('/Website/Review/oemlogin_store', [ReviewController::class, 'oemlogin_review_store']);

Route::post('/Website/Review/Rating_store', [ReviewController::class, 'Ratings_review_store']);
Route::get('/Website/Review/Owner', [ReviewController::class, 'Owner_review']);
Route::get('/Website/Review/Blogger', [ReviewController::class, 'Blogger_review']);
Route::get('/Website/Review/Oem', [ReviewController::class, 'oem_review']);

Route::get('/Website/ratings_review/delete/{id}', [ReviewController::class, 'ratings_review_delete']);
Route::get('/Website/owner_review/delete/{id}', [ReviewController::class, 'owner_review_delete']);

Route::get('/Website/SearchEVvehicle', [ReviewController::class, 'SearchEVvehicle']);

Route::get('/Website/contributors/View/', [ReviewController::class, 'Contributors_view']);
Route::get('/Website/contributors/delete/{id}', [ReviewController::class, 'Contributors_delete']);


// Route::post('/Website/Contributors/store',[ReviewController::class,'Contributors_store']);

//disclaimer
Route::get('/Website/Disclaimer', [DekhoEVHomeController::class, 'disclaimer']);

//header

Route::get('/Website/Header', [DekhoEVHomeController::class, 'header']);
Route::get('/Website/footer', [DekhoEVHomeController::class, 'footer']);
Route::get('/Website/Gyaan', [DekhoEVHomeController::class, 'Gyaan']);
Route::get('/Website/Gyaan/Details', [DekhoEVHomeController::class, 'Gyaan_details']);


// OEM Image Search again Model 
Route::get('/Website/4Wheeler_OEM_Search', [OEMmodelController::class, 'Fourwheeler_OEM']);
Route::get('/Website/2Wheeler_OEM_Search/', [OEMmodelController::class, 'Twowheeler_OEM']);
Route::get('/Website/3Wheeler_Cargo_OEM_Search', [OEMmodelController::class, 'Threewheeler_Cargo_OEM']);
Route::get('/Website/3Wheeler_Pass_OEM_Search', [OEMmodelController::class, 'Threewheeler_Pass_OEM']);
